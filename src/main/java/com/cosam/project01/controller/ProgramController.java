...
public class ProgramController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ProgramDTO> update(@PathVariable Integer id, @RequestBody ProgramDTO dto) {
    ...
    public ResponseEntity<Page<ProgramDTO>> getAllPaginated(
    ...
    /* SOFT DELETE */
    @GetMapping
    public ResponseEntity<List<ProgramDTO>> listActive() {
        return ResponseEntity.ok(service.listActive());
    }

    @GetMapping("/deleted")
    public ResponseEntity<List<ProgramDTO>> listDeleted() {
